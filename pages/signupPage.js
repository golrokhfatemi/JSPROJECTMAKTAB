...
export function signupPage(){
    ...
    return`
    <h2 class="font-serif  text-emerald-800 p-4 text-center font-bold text-2xl"">Signup Page</h2>
      ...
      <div class=" flex justify-center border-solid border-2 flex-col content-center items-center bg-teal-800 w-1/3 rounded-3xl">
        <form> 
              ...
              <div class="flex justify-center">
                <input type="submit" value="signup" class="font-serif border-solid text-white border-2 cursor-pointer border-slate-400  px-4 py-1 mb-2 rounded-md font-semibold">
              </div>
